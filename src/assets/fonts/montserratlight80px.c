...
#ifndef MONTSERRATLIGHT80PX
#define MONTSERRATLIGHT80PX 1
#endif

#if MONTSERRATLIGHT80PX
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xc7, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x75,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 728, .box_w = 35, .box_h = 34, .ofs_x = 5, .ofs_y = 11}
};
...
{
    {
        .range_start = 43, .range_length = 1, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserratlight80px = {
#else
lv_font_t montserratlight80px = {
#endif
