...
static void
GUI_createTimelinePhase(lv_anim_timeline_t *timeline, uint32_t start_time,
                        lv_anim_t *animation, lv_obj_t *object,
                        lv_anim_custom_exec_cb_t animator, int32_t startvalue,
                        int32_t endvalue, uint32_t duration,
