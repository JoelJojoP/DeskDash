...
void GUI_init() { GUI_loadContent(); }

void GUI_refresh() {
    lv_timer_handler();
}

void GUI_initHAL() { HAL_init(); }

void GUI_initFramework() { lv_init(); }
...
void GUI_initScreens() { GUI_initScreenContents(); }

void GUI_loadFirstScreen() { lv_screen_load(GUI_Screen__splashScreen); }

void GUI_initScreenContents() {
    GUI_initScreen__commonElement();
